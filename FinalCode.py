...
if not os.path.exists(pickle_file):
    print(f"Error: File '{pickle_file}' does not exist. Please preprocess the data first.")
    exit()
...
with open(model_file, 'wb') as pick:
...
# Step 7: Visualize predictions for 5 random test samples
for _ in range(5):
